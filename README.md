...
- **Compiling and Running Editor**
    * Navigate to project path and right click `SimpleShooter.uproject` [Unreal Engine Project].
    * Select `Generate Visual Studio Project Files`.
    * Double click the `SimpleShooter.sln`
    * In `Solution Explorer` under `Solution 'SimpleShooter'/Games/SimpleShooter` left click
